...
$APPLICATION->SetTitle("Глава государства - Россия - Выдвижение кандидатов");
    ...
    <div class="col-lg-12">
        <div class="alert alert-info bg-white alert-styled-left alert-arrow-left p-0">
            ...
            <div class="card-body" style="">
                Вы находитесь на странице выдвижения кандидатов на выборах. Вам необходимо ознакомиться с описанием выборной должности и если вы считаете себя подходящим кандидатом для данной должности, то вы можете принять участие в выборах. Для этого необходимо нажать кнопку "Участвовать". Ваша кандидатура будет автоматически добавлена в список кандидатов.
            </div>
        </div>
    </div>
</div>
