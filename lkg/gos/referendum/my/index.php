...
?>
<?if($APPLICATION->GetCurUri()=="/lkg/gos/referendum/my/"):?>
    <div class="row">
    <div class="col-lg-12">
        <div class="alert alert-info bg-white alert-styled-left alert-arrow-left ">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Мои референдумы</h5>
                <button type="button" class="close" data-dismiss="alert"><span>×</span></button>
            </div>

            <div class="card-body" style="">
                <p>В разделе "Мои референдумы" отображаются референдумы, созданные вами.
                </p>
            </div>
        </div>
    </div>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PATH_TO_BLOG" => "/lkg/gos/referendum/my/",
		...
		"PATH_TO_POST" => "/lkg/gos/referendum/my/#post_id#/",
		...
		"STATUS_ID" => "12",
		"USER_ID" => CUSER::GetID(),
		"SEF_FOLDER" => "/lkg/gos/referendum/my/",
