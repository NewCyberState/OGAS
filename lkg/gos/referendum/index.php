...
$APPLICATION->SetTitle("Референдумы");

?>
<?
if($APPLICATION->GetCurUri()=="/lkg/gos/referendum/"):
    ?>
    <div class="row">
        <div class="col-lg-12">
            <div class="alert alert-info bg-white alert-styled-left alert-arrow-left ">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Референдумы</h5>
                    <button type="button" class="close" data-dismiss="alert"><span>×</span></button>
                </div>

                <div class="card-body" style="">
                    <p>В разделе "Референдумы" отображаются законопроекты, вынесенные на референдум. Вам необходимо ознакомиться с текстом каждого законопроекта и проголосовать "За" или "Против".</p>
                    <p>Для того, чтобы вынести законопроект на референдум вам необходимо в разделе "Создание референдума" для каждой вашей петиции, перешедшей на этап "Создание референдума" подготовить, с учетом прошедших обсуждений, текст законопроекта и вынести его на референдум.</p>

                        Законопроект будет принят, если в течение 1 недели с момента начала референдума за него проголосует не менее 50% членов группы.
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PATH_TO_BLOG" => "/lkg/gos/referendum/",
		...
		"PATH_TO_POST" => "/lkg/gos/referendum/#post_id#/",
