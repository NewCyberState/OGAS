...
$APPLICATION->SetTitle("Создание референдумов");
global $USER;
?>
<?if($APPLICATION->GetCurUri()=="/lkg/gos/referendum/add/"):?>
    <div class="row">
        <div class="col-lg-12">
            <div class="alert alert-info bg-white alert-styled-left alert-arrow-left ">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Создание референдумов</h5>
                    <button type="button" class="close" data-dismiss="alert"><span>×</span></button>
                </div>

                <div class="card-body" style="">
                    <p>В разделе "Создание референдумов" отображаются ваши петиции, которые прошли этап общественных обсуждений и на основании которых вам сейчас необходимо создать новый референдум. Для этого войдите в каждую петицию, изучите результаты обсуждений и подготовьте текст законопроекта, который будет вынесен на референдум. Сохраните новый референдум, он появится в разделе "Мои референдумы". Все граждане, состоящие в группе, с которой была связана исходная петиция, увидят новый референудм и смогут за него проголосовать. По окончании голосования, если законопроект будет утвержден большинством голосов членов группы - он станет законом и появится в разделе "Принятые законы".</p>
                </div>
            </div>
        </div>
    </div>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PATH_TO_BLOG" => "/lkg/gos/referendum/add/",
		...
		"PATH_TO_POST" => "/lkg/gos/referendum/add/#post_id#/",
		...
		"STATUS_ID" => "11",
		"USER_ID" => CUSER::GetID(),
		"SEF_FOLDER" => "/lkg/gos/referendum/add/",
