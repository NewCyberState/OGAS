...
if($_REQUEST["my"]=="Y") {
    $arrFilter = array("PROPERTY_STATUS" => 8, "CREATED_BY" => $USER->GetID(),"PROPERTY_GROUP_ID"=>$USER_SONET_GROUPS);
}
else {
    $arrFilter = array("PROPERTY_STATUS" => 8,"PROPERTY_GROUP_ID"=>$USER_SONET_GROUPS);
}

?>
<?
if($APPLICATION->GetCurPage()=="/lkg/gos/law/executed/"):
    ?>
        ...
        <div class="col-lg-12">
            <div class="alert alert-info bg-white alert-styled-left alert-arrow-left p-0">
                ...
                <div class="card-body" style="">
                    <p>В разделе "Исполненные законы" отображаются законы, которые были приняты и исполнены ответственными за их исполнения. Вы можете оценить исполнение каждого закона.
                    </p>
                </div>
            </div>
        </div>
