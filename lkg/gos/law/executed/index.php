...
$APPLICATION->SetTitle("Исполненные законы");

?>
<?
if($APPLICATION->GetCurUri()=="/lkg/gos/law/executed/"):
    ?>
        ...
        <div class="col-lg-12">
            <div class="alert alert-info bg-white alert-styled-left alert-arrow-left ">
                ...
                <div class="card-body" style="">
                    <p>В разделе "Исполненные законы" отображаются законы, которые были приняты и исполнены органами исполнительной власти. Вы можете оценить исполнение каждого закона - это повлияет на рейтинги органов власти. Рейтинги органов власти влияют на уровень заработных плат и премии сотрудников органов власти.
                    </p>
                </div>
            </div>
        </div>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PATH_TO_BLOG" => "/lkg/gos/law/executed/",
		...
		"PATH_TO_POST" => "/lkg/gos/law/executed/#post_id#/",
		...
		"STATUS_ID" => "16",
		"USER_ID" => false,
		"SEF_FOLDER" => "/lkg/gos/law/executed/",
