...
if($_REQUEST["my"]=="Y") {
    ...
    $APPLICATION->SetTitle("Мои законы");
}
else {
    $arrFilter = array(">PROPERTY_STATUS" => 4,"PROPERTY_GROUP_ID"=>$USER_SONET_GROUPS);
    $APPLICATION->SetTitle("Законы");
}
?>
<?
if($APPLICATION->GetCurPage()=="/lkg/gos/law/"):
    ?>
        ...
        <div class="col-lg-12">
            <div class="alert alert-info bg-white alert-styled-left alert-arrow-left p-0">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Законы</h5>
                    <button type="button" class="close" data-dismiss="alert"><span>×</span></button>
                </div>

                <div class="card-body" style="">
                    <p>В разделе "Законы" отбражаются все законы во всех статусах.
                    </p>
                </div>
            </div>
        </div>
