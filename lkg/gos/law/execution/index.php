...
$APPLICATION->SetTitle("Законы на исполнении");
...
?>
<?
if($APPLICATION->GetCurUri()=="/lkg/gos/law/execution/"):
    ?>
        ...
        <div class="col-lg-12">
            <div class="alert alert-info bg-white alert-styled-left alert-arrow-left ">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Законы на исполнении</h5>
                    <button type="button" class="close" data-dismiss="alert"><span>×</span></button>
                </div>

                <div class="card-body" style="">
                    <p>В разделе "Законы на исполнении" отображаются законы, которые были приняты на референдуме и находятся на исполнении у органов исполнительной власти. Если закон имеет срок исполнения, то по окончании исполнения он будет переведен в статус "Закон исполнен". Вы можете оценить исполнение каждого закона - это повлияет на рейтинги органов власти. Рейтинги органов власти влияют на уровень заработных плат и премии сотрудников органов власти.
                    </p>
                </div>
            </div>
        </div>
...
<?$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "PATH_TO_BLOG" => "/lkg/gos/law/execution/",
        ...
        "PATH_TO_POST" => "/lkg/gos/law/execution/#post_id#/",
        ...
        "STATUS_ID" => "15",
        "USER_ID" => false,
        "SEF_FOLDER" => "/lkg/gos/law/execution/",
