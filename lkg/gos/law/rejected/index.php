...
if($_REQUEST["my"]=="Y") {
    $arrFilter = array("PROPERTY_STATUS" => 6, "CREATED_BY" => $USER->GetID(),"PROPERTY_GROUP_ID"=>$USER_SONET_GROUPS);
}
else {
    $arrFilter = array("PROPERTY_STATUS" => 6,"PROPERTY_GROUP_ID"=>$USER_SONET_GROUPS);
}
?>
<?
if($APPLICATION->GetCurPage()=="/lkg/gos/law/rejected/"):
    ?>
