...
?><div class="row">
    <div class="col-lg-12">
        <div class="alert alert-info bg-white alert-styled-left alert-arrow-left ">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Мои обсуждения</h5>
                <button type="button" class="close" data-dismiss="alert"><span>×</span></button>
            </div>

            <div class="card-body" style="">
                В разделе "Мои обсуждения" отображаются обсуждения петиций, добавленных вами.
            </div>
        </div>
    </div>
	...
	array(
		...
		"PATH_TO_BLOG" => "/lkg/gos/discussion/my/",
		...
		"PATH_TO_POST" => "/lkg/gos/discussion/my/#post_id#/",
		...
		"STATUS_ID" => "10",
		"USER_ID" => CUser::GetID(),
		"SEF_FOLDER" => "/lkg/gos/discussion/my/",
