        ...
        <div class="col-lg-12">
            <div class="alert alert-info bg-white alert-styled-left alert-arrow-left">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Петиции</h5>
                    <button type="button" class="close" data-dismiss="alert"><span>×</span></button>
                </div>

                <div class="card-body" style="">
                    <p>В разделе "Петиции" отображаются петиции, добавленные гражданами в группы, в которые вы ранее вступили. Вам необходимо ознакомиться с каждой петицией и если вы хотите ее поддержать - нужно нажать на ссылку "Поддержать". Для того, чтобы петиция перешла на следующий этап законодательного процесса она должна набрать не менее 10% голосов от общего числа членов группы, в которую она добавлена.</p>
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PATH_TO_POST" => "/lkg/gos/petition/#post_id#/",
