...
$APPLICATION->SetTitle("Выборы");

if(intval($_GET["group_id"])>0)
    $socnet_group_id=intval($_GET["group_id"]);
?>
<?
if($APPLICATION->GetCurUri()=="/lkg/gos/elections/"):
    ?>
    <div class="row">
        <div class="col-lg-12">
            <div class="alert alert-info bg-white alert-styled-left alert-arrow-left">
                ...
                <div class="card-body" style="">
                    <p>В разделе "Выборы" отображаются все этапы выборного процесса во  во всех группах, в которые вы ранее вступили. </p>
                    <p><b>Вы можете создать новые выборы:</b></p>
                    <a href="add/" class="btn btn-info"><i class="icon-copy  mr-2"></i>Добавить выборы</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header header-elements-inline bg-white">
                    <h5 class="card-title">Выдвижение кандидатов</h5>
                    <div class="header-elements">
                        <span><a href="/lkg/gos/petition/?group_id=Array">Все выдвижения</a></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-header bg-light d-flex header-elements-inline">
                    <h6 class="font-weight-semibold mb-0 flex-grow-1 card-title text-truncate">
                        <a href="https://ogasdemo.ru/lkg/gos/elections/stand/" class="d-block" title="">Глава государства</a> <span class="font-size-base text-muted">Россия</span>
                    </h6>
                    <div class="header-elements">
                        <a href="#" title=""><span class="badge bg-success ml-2">Выдвижение</span></a>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div data-mrc id="collapseSummary1">
                        <h6>Кандидаты (10):</h6>
                    - Иван Иванов<br>
                    - Петр Петров<br>
                    - Семен Семенов<br>
        ...
        <div class="col-lg-6 col-xl-3">
            ...
            <div class="card">
                ...
                <div class="card-header bg-light d-flex header-elements-inline">
                    <h6 class="font-weight-semibold mb-0 flex-grow-1 card-title text-truncate">
                        <a href="https://ogasdemo.ru/lkg/gos/elections/stand/" class="d-block" title="">Депутат парламента</a> <span class="font-size-base text-muted">Россия</span>
                    </h6>
                    <div class="header-elements">
                        <a href="#" title=""><span class="badge bg-success ml-2">Выдвижение</span></a>
                    </div>
        ...
        <div class="col-lg-6 col-xl-3">
            ...
            <div class="card">
                ...
                <div class="card-header bg-light d-flex header-elements-inline">
                    <h6 class="font-weight-semibold mb-0 flex-grow-1 card-title text-truncate">
                        <a href="https://ogasdemo.ru/lkg/gos/elections/stand/" class="d-block" title="">Глава города</a> <span class="font-size-base text-muted">Москва</span>
                    </h6>
                    <div class="header-elements">
                        <a href="#" title=""><span class="badge bg-success ml-2">Выдвижение</span></a>
                    </div>
        ...
        <div class="col-lg-6 col-xl-3">
            ...
            <div class="card">
                ...
                <div class="card-header bg-light d-flex header-elements-inline">
                    <h6 class="font-weight-semibold mb-0 flex-grow-1 card-title text-truncate">
                        <a href="https://ogasdemo.ru/lkg/gos/elections/stand/" class="d-block" title="">Руководитель</a> <span class="font-size-base text-muted">Институт системной социологии</span>
                    </h6>
                    <div class="header-elements">
                        <a href="#" title=""><span class="badge bg-success ml-2">Выдвижение</span></a>
                    </div>
    ...
    <div class="row">
        <div class="col-lg-6 col-xl-3">
            ...
            <div class="card">
                ...
                <div class="card-header bg-light d-flex header-elements-inline">
                    <h6 class="font-weight-semibold mb-0 flex-grow-1 card-title text-truncate">
                        <a href="https://ogasdemo.ru/lkg/gos/elections/voting/" class="d-block" title="">Глава государства</a> <span class="font-size-base text-muted">Россия</span>
                    </h6>
                    <div class="header-elements">
                        <a href="#" title=""><span class="badge bg-success ml-2">Выдвижение</span></a>
                    </div>
        ...
        <div class="col-lg-6 col-xl-3">
            ...
            <div class="card">
                ...
                <div class="card-header bg-light d-flex header-elements-inline">
                    <h6 class="font-weight-semibold mb-0 flex-grow-1 card-title text-truncate">
                        <a href="https://ogasdemo.ru/lkg/gos/elections/voting/" class="d-block" title="">Депутат парламента</a> <span class="font-size-base text-muted">Россия</span>
                    </h6>
                    <div class="header-elements">
                        <a href="#" title=""><span class="badge bg-success ml-2">Выдвижение</span></a>
                    </div>
        ...
        <div class="col-lg-6 col-xl-3">
            ...
            <div class="card">
                ...
                <div class="card-header bg-light d-flex header-elements-inline">
                    <h6 class="font-weight-semibold mb-0 flex-grow-1 card-title text-truncate">
                        <a href="https://ogasdemo.ru/lkg/gos/elections/voting/" class="d-block" title="">Глава города</a> <span class="font-size-base text-muted">Москва</span>
                    </h6>
                    <div class="header-elements">
                        <a href="#" title=""><span class="badge bg-success ml-2">Выдвижение</span></a>
                    </div>
        ...
        <div class="col-lg-6 col-xl-3">
            ...
            <div class="card">
                ...
                <div class="card-header bg-light d-flex header-elements-inline">
                    <h6 class="font-weight-semibold mb-0 flex-grow-1 card-title text-truncate">
                        <a href="https://ogasdemo.ru/lkg/gos/elections/voting/" class="d-block" title="">Руководитель</a> <span class="font-size-base text-muted">Институт системной социологии</span>
                    </h6>
                    <div class="header-elements">
                        <a href="#" title=""><span class="badge bg-success ml-2">Выдвижение</span></a>
                    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header header-elements-inline bg-white">
                    ...
                    <div class="header-elements">
                        <span><a href="/lkg/gos/petition/?group_id=Array">Все итоги</a></span>
                    </div>
                </div>
            </div>
        </div>
