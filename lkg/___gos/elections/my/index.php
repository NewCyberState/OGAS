        ...
        <div class="col-lg-12">
            <div class="alert alert-info bg-white alert-styled-left alert-arrow-left">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Мои петиции</h5>
                    <button type="button" class="close" data-dismiss="alert"><span>×</span></button>
                </div>

                <div class="card-body" style="">
                    <p>В разделе "Мои петиции" отображаются петиции, добавленные вами.</p>
                </div>
            </div>
        </div>
    </div>
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PATH_TO_BLOG" => "/lkg/gos/petition/my/",
		...
		"PATH_TO_POST" => "/lkg/gos/petition/my/#post_id#/",
		...
		"STATUS_ID" => "9",
		"USER_ID" => $USER->GetID(),
		"SEF_FOLDER" => "/lkg/gos/petition/my/",
