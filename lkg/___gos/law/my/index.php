        ...
        <div class="col-lg-12">
            <div class="alert alert-info bg-white alert-styled-left alert-arrow-left ">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Мои законы</h5>
                    <button type="button" class="close" data-dismiss="alert"><span>×</span></button>
                </div>

                <div class="card-body" style="">
                    <p>В разделе "Мои законы" отображаются законы, принятые на основании петиций, созданных вами.</p>
                </div>
            </div>
        </div>
    </div>
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PATH_TO_POST" => "/lkg/gos/law/my/#post_id#/",
