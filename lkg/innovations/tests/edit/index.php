...
$APPLICATION->SetTitle("Компактный кроссовер - Испытания");
    ...
    <div class="col-lg-12">
        <div class="alert alert-info bg-white alert-styled-left alert-arrow-left ">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Испытания</h5>
                <button type="button" class="close" data-dismiss="alert"><span>×</span></button>
            </div>

            <div class="card-body" style="">
                Страница подробного описания испытаний.
            </div>
        </div>
    </div>
</div>
    <div class="d-flex align-items-start flex-column flex-md-row">
            ...
            <div class="card">
                <div class="card-header header-elements-md-inline">
                    ...
                    <div class="header-elements">
                        <span class="badge bg-success ml-2">Испытания</span>
                    </div>
                </div>

                <div class="nav-tabs-responsive bg-light border-top">
                    <ul class="nav nav-tabs nav-tabs-bottom flex-nowrap mb-0">
                        <li class="nav-item"><a href="#tab4" class="nav-link active" data-toggle="tab"><i class="icon-clipboard2  mr-2"></i> Испытания</a></li>
        ...
        <div class="sidebar sidebar-light bg-transparent sidebar-component sidebar-component-right border-0 shadow-0 order-1 order-md-2 sidebar-expand-md">
            ...
            <div class="sidebar-content">
                ...
                <div class="card">
                    <div class="card-header bg-transparent header-elements-inline">
                        <span class="text-uppercase font-size-sm font-weight-semibold">Принять участие в испытаниях</span>
                        <div class="header-elements">
                            <div class="list-icons">
                                <a class="list-icons-item" data-action="collapse"></a>
                            </div>
                    ...
                    <div class="card-body pb-0">
                        <a href="#" class="btn btn-primary btn-block mb-2"><i class="icon-clipboard2 mr-2"></i>Принять участие</a>
                    </div>
                    ...
                    <table class="table table-borderless table-xs border-top-0 my-2">
                        <tbody>
                        <tr>
                            <td class="">Подробнее о правилах участия в испытаниях читайте <a href="">по ссылке</a>.</td>
                        </tr>
                ...
                <div class="card">
                    <div class="card-header bg-transparent header-elements-inline">
                        <span class="text-uppercase font-size-sm font-weight-semibold">Приобрести опытный образец</span>
                        <div class="header-elements">
                            <div class="list-icons">
                                <a class="list-icons-item" data-action="collapse"></a>
                            </div>
                    ...
                    <div class="d-flex justify-content-center text-center mb-0 mt-2">
                        <div class="h2">
                            1 000 000 <small>р.</small>
                        </div>
                    </div>

                    <div class="card-body pb-0">
                        <a href="#" class="btn btn-warning btn-block mb-2"><i class="icon-cart-add mr-2"></i>Заказать</a>
                    </div>
                    ...
                    <table class="table table-borderless table-xs border-top-0 my-2">
                        <tbody>
                        <tr>
                            <td class="">После приобретения опытного образца вы обязаны предоставить автору изобретения отчет об испытаниях.</td>
                        </tr>
                ...
                <div class="card">
                    <div class="card-header bg-transparent header-elements-inline">
                        <span class="text-uppercase font-size-sm font-weight-semibold">Выделить грант</span>
                        <div class="header-elements">
                            <div class="list-icons">
                                <a class="list-icons-item" data-action="collapse"></a>
                            </div>
                    ...
                    <div class="d-flex justify-content-center text-center m-2">
                        На доработку изобретения по результатам испытаний автор просит:
                    </div>

                    <div class="d-flex justify-content-center text-center mb-0 mt-2">
                        <div class="h2">
                            3 000 000 <small>р.</small>
                        </div>
                    </div>

                    <div class="card-body pb-0">
                        <a href="/lkg/innovations/standarts/edit/" class="btn btn-success btn-block mb-2"><i class="icon-thumbs-up2 mr-2"></i>Поддержать</a>
                    </div>
