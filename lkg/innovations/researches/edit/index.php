    ...
    <div class="col-lg-12">
        <div class="alert alert-info bg-white alert-styled-left alert-arrow-left ">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Исследование</h5>
                <button type="button" class="close" data-dismiss="alert"><span>×</span></button>
            </div>

            <div class="card-body" style="">
                Страница подробного описания исследования.
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-header header-elements-md-inline">
                    ...
                    <div class="header-elements">
                        <span class="badge bg-success ml-2">Исследование</span>
                    </div>
                </div>

                <div class="nav-tabs-responsive bg-light border-top">
                    <ul class="nav nav-tabs nav-tabs-bottom flex-nowrap mb-0">
                        <li class="nav-item"><a href="#tab2" class="nav-link active" data-toggle="tab"><i class="icon-zoomin3  mr-2"></i> Исследование</a></li>
            ...
            <div class="sidebar-content">
                ...
                <div class="card">
                    ...
                    <div class="d-flex justify-content-center text-center m-2">
                        Для разработки опытного образца автор просит:
                    </div>

                    <div class="d-flex justify-content-center text-center mb-2 mt-2">
                        <div class="h2">
                            10 000 000 <small>р.</small>
                        </div>
                    </div>

                    <div class="card-body pb-0">
                        <a href="/lkg/innovations/developments/edit/" class="btn btn-success btn-block mb-2"><i class="icon-thumbs-up2 mr-2"></i>Поддержать</a>
                    </div>
