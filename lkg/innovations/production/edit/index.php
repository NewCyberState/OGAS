...
$APPLICATION->SetTitle("Компактный кроссовер - Производство");
    ...
    <div class="col-lg-12">
        <div class="alert alert-info bg-white alert-styled-left alert-arrow-left ">
            ...
            <div class="card-body" style="">
                Страница подробного описания серийного изделия.
            </div>
        </div>
    </div>
</div>
    <div class="d-flex align-items-start flex-column flex-md-row">
            ...
            <div class="card">
                <div class="card-header header-elements-md-inline">
                    ...
                    <div class="header-elements">
                        <span class="badge bg-success ml-2">Производство</span>
                    </div>
                </div>

                <div class="nav-tabs-responsive bg-light border-top">
                    <ul class="nav nav-tabs nav-tabs-bottom flex-nowrap mb-0">
                        <li class="nav-item"><a href="#tab6" class="nav-link active" data-toggle="tab"><i class="icon-hammer-wrench mr-2"></i> Производство</a></li>
                        <li class="nav-item"><a href="#tab5" class="nav-link" data-toggle="tab"><i class="icon-certificate mr-2"></i> Стандарт</a></li>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab6">
                        <div class="card-body text-center">
                            ...
                            <img src="https://www.lada-vesta2.ru/images/xray_photo/29822.jpg" class="img-fluid">



                            <img src="https://www.lada-vesta2.ru/images/xray_photo/29821.jpg" class="img-fluid">

                            <img src="https://www.lada-vesta2.ru/images/xray_photo/29820.jpg" class="img-fluid">

                            <img src="https://www.lada-vesta2.ru/images/xray_photo/29824.jpg" class="img-fluid">

                            <iframe width="100%" height="750" src="https://www.youtube.com/embed/zIKdsOU-qZg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    ...
                    <div class="tab-pane fade" id="tab5">
                        <div class="card-body">
                            <div class="mt-1 mb-1">
                                ...
                                <h3 class="mt-4">Технические требования</h3>

                                <h3>Требования к безопасности</h3>

                                <h3>Требования к контролю и приемке</h3>
        ...
        <div class="sidebar sidebar-light bg-transparent sidebar-component sidebar-component-right border-0 shadow-0 order-1 order-md-2 sidebar-expand-md">
            ...
            <div class="sidebar-content">
                ...
                <div class="card">
                    <div class="card-header bg-transparent header-elements-inline">
                        <span class="text-uppercase font-size-sm font-weight-semibold">Розничная цена</span>
                        <div class="header-elements">
                            <div class="list-icons">
                                <a class="list-icons-item" data-action="collapse"></a>
                            </div>
                ...
                <div class="card">
                    <div class="card-header bg-transparent header-elements-inline">
                        <span class="text-uppercase font-size-sm font-weight-semibold">Предзаказ</span>
                        <div class="header-elements">
                            <div class="list-icons">
                                <a class="list-icons-item" data-action="collapse"></a>
                            </div>
                    ...
                    <div class="card-body text-center mb-0 pb-0">
                        <p class="mb-3">Вы можете оставить предзаказ на данную модель. Когда серийное производство модели будет налажено, вы получите оповещение.</p>

                        <button class="btn btn-primary" ><i class="icon-clipboard3 mr-2"></i>Оставить предзаказ</button>



                    </div>
                    <table class="table table-borderless border-top-0 my-2">
                        <tbody>
                        <tr>
                            <td class="font-weight-semibold">Предзаказов:</td>
                ...
                <div class="card">
                    <div class="card-header bg-transparent header-elements-inline">
                        <span class="text-uppercase font-size-sm font-weight-semibold">Премия автору</span>
                        <div class="header-elements">
                            <div class="list-icons">
                                <a class="list-icons-item" data-action="collapse"></a>
                            </div>
                    ...
                    <div class="card-body text-center">
                        <p>За успешно разработанное и направленное в серийное производство изобретение, автор получает из госбюджета единоразовую премию</p>
                        <h2>10 000 000 руб.</h2>
