...
Портал разрабатывается на платформе "1С-Битрикс: Управление сайтом", редакция "Бизнес". Если вы веб-разработчик "1С-Битрикс" - вы можете помочь разработке проекта. Свяжитесь с администрацией проекта по адресу: info@ogasdemo.ru 
