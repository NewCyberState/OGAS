...
?>
    ...
    <script>
        $(document).ready( function() {
            ...
            /*$(".ogas span").typed({
                strings: ["^0<i>ОГАС</i>^0<br>Общегосyдарственная<br>Автомати3ированная<br>Система^0"],
                typeSpeed: 5,
                loop: false,
                backSpeed: 0,
                contentType: 'html',
...
<div class="ogas">
    <span><i>ОГАС</i><br>Общегосyдарственная<br>Автомати3ированная<br>Система</span>
    <div class="buttons" >
       <a href='javascript:' id='showauth' onclick='$(".ogas").fadeOut(function() {$("#authblock").fadeIn();$(".navbar").removeClass("d-none");$("#bgvideo").get(0).pause();});' class='btn btn-light bg-white font-size-lg '>Войти в систему</a><br>
        ...
        <a href="mailto:info@ogasdemo.ru" target="_blank"><b class="icon-envelop5 mr-2 mt-2 fa-2x font-weight-normal text-white"></b></a>
