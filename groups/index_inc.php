...
<div class="filter-box filter-people">
	<form method="get" action="/groups/" class="bx-selector-form filter-form">
		...
		<div class="filter-button">
			...
			<input type="reset" name="del_filter" value="Отмена" class="filter-submit filter-inline" onclick="window.location='/groups/'" />
		</div>
	</form>
</div>
	</div>
