...
<li class="vote-question<!--Q_ID--> vote-question-saved<!--/Q_ID-->" data-bx-role="question" data-bx-number="#Q#" id="question_#Q#" >
	<div class="vote-block-title-wrap">
		...
		<textarea name="{$pr}[QUESTIONS][#Q#][QUESTION]" placeholder="" class="vote-block-title" data-bx-question-field="MESSAGE"  data-bx-action="adda" rows="10">#Q_VALUE#</textarea>
