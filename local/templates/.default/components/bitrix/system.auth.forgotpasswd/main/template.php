            ...
            <div class="card-body">
                ...
                <form name="bform" method="post" target="_top" class="bf" action="<?=SITE_DIR?>auth/forgot-password/">
                    ...
                    <div class="form-group form-group-feedback form-group-feedback-right">
                            <input type="text" class="form-control"  name="USER_LOGIN" required="required" placeholder="E-mail" maxlength="255" />
                    </div>
                    ...
                    <?endif;?>
                    <div class="but-r">
                        <input class="btn bg-success  btn-block" type="submit" name="send_account_info" value="<?=GetMessage("RETRIEVE")?>" />
                    </div>
                </form>
                </div>
<?endif;?>
