...
$labours = $company->GetLabours();
$classes = $company->GetClasses();
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if (intval($propertyID) > 0) {
                            ...
                            if (intval($propertyID) == 108) //Свойства "Компания" прячем
                                $arResult["PROPERTY_LIST_FULL"][$propertyID]["PROPERTY_TYPE"] = "H";

                            if (intval($propertyID) == 106) //Свойства "Пользователь" выводим как список
                        ...
                        switch ($INPUT_TYPE):
                            case "H":
                                ...
                                for ($i = 0; $i < $inputNum; $i++) {
                                    ...
                                    <input type="hidden" name="PROPERTY[<?= $propertyID ?>][<?= $i ?>]"
                                           value="<?= $value ?>"/>
                                <?
                                } ?>
                            <?
                            ...
                            case "E":
                                ...
                                //pr($labours);
                                if ($arResult["PROPERTY_LIST_FULL"][$propertyID][LINK_IBLOCK_ID] == FACTORS_IBID)
                                    $ar = $labours;
                                elseif ($arResult["PROPERTY_LIST_FULL"][$propertyID][LINK_IBLOCK_ID] == TARIFFGRID_IBID)
                                    $ar = $classes;
                                elseif ($arResult["PROPERTY_LIST_FULL"][$propertyID][LINK_IBLOCK_ID] == POSITION_IBID)
                                    $ar = $positions;
                                elseif ($propertyID==106)
                                    $ar = $users;
                                ...
                                <select class="form-control select"
                                    ...
                                    foreach ($ar as $key => $arEnum) {
                                        $checked = false;
                                        if ($arResult[ELEMENT_PROPERTIES][$propertyID][0][VALUE] == $key) {
                                            $checked = true;
                                        }
                                        ?>
                                        <option value="<?= $key ?>" <?= $checked ? " selected=\"selected\"" : "" ?>><?= $arEnum ?></option>
                                        <?
                                    }
                                    ?>
                                </select>
