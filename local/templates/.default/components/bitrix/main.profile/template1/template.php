...
<table class="profile-table data-table">
	...
	<tr>
		...
		<td><input type="text" name="TITLE"  class="form-control" value="<?=$arResult["arUser"]["TITLE"]?>" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text"  class="form-control" name="SECOND_NAME" maxlength="50" value="<?=$arResult["arUser"]["SECOND_NAME"]?>" /></td>
	</tr>
	<tr>
