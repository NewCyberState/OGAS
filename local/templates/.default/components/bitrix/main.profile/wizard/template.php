                                        ...
                                        <div class="card">
                                            <div class="card-body text-center">
                                                <div class="card-img-actions d-inline-block">
                                                    <a  data-popup="popover" data-trigger="hover" data-placement="top" data-content="<?=$user[PERSONAL_NOTES]?>"  href="javascript:" class="btn btn-outline bg-white border-white border-2 btn-icon rounded-round">
                                                ...
                                                <div class="d-block mb-1">
                                                    ...
                                                    <a  data-popup="popover" data-trigger="hover" data-placement="top" href="javascript:" data-content="<?=$user[PERSONAL_NOTES]?>" class="">О себе</a>
                                    <?else:?>
                                                    <br>
                                    <?endif;?>
                                                </div>
                ...
                <fieldset>
                    <div class="row">
                        <div class="col-md-12  text-center">
                            ...
                            <div class="form-group">
                                <h5>Поздравляем, вы стали гражданином Нового Кибернетического Государства! Теперь вам доступен весь функционал Общегосударственной Автоматизированной Системы. Вы можете создавать петиции, принимать участие в обсуждениях, участвовать в референдумах и другие возможности. В случае, если вы не сможете самостоятельно принять участия в голосованиях на референдумах - за вас смогут это сделать ваши делегаты. При принятии любых общегосударственных решений ваш голос всегда будет учтен!</h5>

                                <h5>Нажав кнопку "Готово" вы перейдете в раздел "Управление государством", где сможете воспользоваться всеми функциональными возможностями, доступными гражданину.</h5>
