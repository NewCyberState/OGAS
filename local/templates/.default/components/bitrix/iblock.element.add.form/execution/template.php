...
?>
                ...
                <form name="iblock_add" action="<?= POST_FORM_ACTION_URI ?>" method="post"
                    ...
                    <input type="hidden" name="PROPERTY[IBLOCK_SECTION][]" value="108" id="category">
                    ...
                    <div class="table-responsive shadow-0 mb-0 table-bordered bg-light">
                                            ...
                                            <td>
                                                ...
                                                <select name="PROPERTY[76][0]" class="form-control select select-search"
                                                    ...
                                                    ?>
                                                            ...
                                                            <option value="<?= $res[ID] ?>" <?if($res[ID]==$selected)echo 'selected';?>><?= $res["USER_NAME"]." ".$res["USER_LAST_NAME"]  ?></option>
