...
if($el["PROPERTIES"]["STATUS"]["VALUE"]==3 && $arResult[VARIABLES][SECTION_CODE]!="drafts")
	LocalRedirect("/lkg/gos/drafts/".$arResult[VARIABLES][ELEMENT_ID]."/");

if($el["PROPERTIES"]["STATUS"]["VALUE"]==4 && $arResult[VARIABLES][SECTION_CODE]!="referendums")
	LocalRedirect("/lkg/gos/referendums/".$arResult[VARIABLES][ELEMENT_ID]."/");

if($el["PROPERTIES"]["STATUS"]["VALUE"]==5 && $arResult[VARIABLES][SECTION_CODE]!="approved")
	LocalRedirect("/lkg/gos/law/approved/".$arResult[VARIABLES][ELEMENT_ID]."/");

if($el["PROPERTIES"]["STATUS"]["VALUE"]==6 && $arResult[VARIABLES][SECTION_CODE]!="rejected")
	LocalRedirect("/lkg/gos/law/rejected/".$arResult[VARIABLES][ELEMENT_ID]."/");

if($el["PROPERTIES"]["STATUS"]["VALUE"]==7 && $arResult[VARIABLES][SECTION_CODE]!="execution")
	LocalRedirect("/lkg/gos/law/execution/".$arResult[VARIABLES][ELEMENT_ID]."/");

if($el["PROPERTIES"]["STATUS"]["VALUE"]==8 && $arResult[VARIABLES][SECTION_CODE]!="executed")
	LocalRedirect("/lkg/gos/law/executed/".$arResult[VARIABLES][ELEMENT_ID]."/");
