...
global $arrFilter;
$arStatus = GetHLElement(4, $arrFilter[PROPERTY_STATUS]);
/*if($arrFilter[PROPERTY_GROUP_ID])
    $groupid="?group_id=".$arrFilter[PROPERTY_GROUP_ID];*/
//pr($arParams);
?>
<?if($arStatus):?>
    <h5 class="mb-3 font-weight-semibold"><a href="<?= "/lkg/gos/".$arStatus["UF_LINK"] . "/" . $groupid ?>"><?= $arStatus["UF_DESCRIPTION"]  ?></a></h5>
<?endif;?>

<div class="row mb-2 text-left d-block">
