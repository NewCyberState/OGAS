...
{
	?><div class='alert alert-danger alert-dismissible border-0  mb-0'><?=$arResult["FatalError"]?></div><?
}
else
{
	if(
	...
	{
        ?><div class='alert alert-danger alert-dismissible border-0 mb-0'><?=$arResult["ErrorMessage"]?></div><?
	}
	...
	{
		?>
        <div class="alert alert-success border-0 alert-dismissible mb-0">
