...
<? if ($arResult["FORM_TYPE"] === "login"): ?>
                    ...
                    <div class="card-body">
                        ...
                        <form id="avtorization-form" name="system_auth_form<?= $arResult["RND"] ?>" method="post"
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left"
                                 data-sid="USER_LOGIN_POPUP">

                                <input type="text" name="USER_LOGIN" placeholder="E-mail" id="USER_LOGIN"
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-left"
                                 data-sid="USER_PASSWORD">

                                <input type="password" name="USER_PASSWORD" placeholder="Пароль"
                                       id="USER_PASSWORD" required class="form-control required password"
                                       maxlength="50" value="" autocomplete="on" tabindex="2"/>
                                <div class="form-control-feedback">
                                ...
                                <div class="form-check mb-0">
                                    <label class="form-check-label">
                                        ...
                                        <input type="checkbox" id="USER_REMEMBER_frm2" name="USER_REMEMBER" value="Y"
                                               tabindex="5" class="form-input-styled" checked data-fouc/>
                                        Запомнить
                                    </label>
                                </div>

                                <a href="<?= $arParams["AUTH_FORGOT_PASSWORD_URL"] ?>" class="ml-auto">Забыли
                                    пароль?</a>
                            </div>

                            <div class="form-group">
                                <button type="submit" name="Login" class="btn btn-primary btn-block">Войти <i
                        ...
                        <div class="form-group text-center text-muted content-divider ">
                            <span class="px-2">или войти через</span>
                        </div>
                        ...
                        <div class="form-group text-center text-muted content-divider">
                            <span class="px-2">Еще не зарегистированы?</span>
                        </div>

                        <div class="form-group">
                            <a href="<?= $arParams["AUTH_REGISTER_URL"]; ?>" class="btn btn-primary btn-block">Регистрация <i
                                        class="icon-circle-right2 ml-2"></i></a>
                        </div>

                        <span class="form-text text-center text-muted">Регистрируясь, вы принимаете условия<br><a href="/policy/">Пользовательского соглашения</a> и <br><a
                                    href="/privacy/">Политики обработки персональных данных</a></span>
    ...
    <div class="card-body">
    <div class="text-center mb-3">
        <img src="<?=SITE_TEMPLATE_PATH?>/img/ogaslogo2.png" class="mb-3 mt-1" style="height:40px;width:40px">
        <h5 class="mb-2">Общегосударственная Автоматизированная Система</h5>
        <span class="d-block text-muted">Войти в систему</span>
    </div>
