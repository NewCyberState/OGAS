            ...
            <div class="card-body">
                <form action="#">
                    <div class="form-group">
                        ...
                        <input id="POST_TITLE" name="POST_TITLE" class="form-control"  type="text" value="<?=$arResult["PostToShow"]["TITLE"]?>" placeholder="Введите тему"/>
                    </div>



                    <div class="form-group">
                        <label>Текст петиции:</label>
                    ...
                    <div class="text-left">
                        ...
                        else
                        {
                            ...
                            foreach($arButtons as $val)
                            {
                                ...
                                {
                                    ?><button class="btn btn-primary" id="blog-submit-button-<?=$val["NAME"]?>"><?=$val["TEXT"]?></button><?
                                }
                                else
                                {
                                    ?><button class="btn btn-primary ml-1" id="blog-submit-button-<?=$val["NAME"]?>"><?=$val["TEXT"]?><i class="icon-paperplane ml-2"></i></button><?
                                }
                            }
                            if (!empty($scriptFunc))
                            {
...
HTML;
	...
	if ($arResult["SHOW_FULL_FORM"]) // lazyloadmode on + ajax
	{
        ...
        <input type="hidden" name="UF_STATUS" id="UF_STATUS" value="12">
        <input type="hidden" name="UF_STATUS_DATE" id="UF_STATUS_DATE" value="<?=date("d.m.Y H:i:s")?>">
			<?=bitrix_sessid_post();?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                            <div class="form-group">
                                                <label>Тема референдума</label>

                                               <input id="POST_TITLE" name="POST_TITLE" class="feed-add-post-inp feed-add-post-inp-active form-control" <?
						?>type="text" value="<?=$arResult["PostToShow"]["TITLE"]?>" placeholder="Тема петиции" />
...
?>
				...
				<?foreach ($arResult["POST_PROPERTIES"]["DATA"] as $FIELD_NAME => $arPostField)
				{
					if(in_array($FIELD_NAME, $arParams["POST_PROPERTY_SOURCE"]))
					{
                        ...
                        if($FIELD_NAME=="UF_BLOG_POST_VOTE") {
