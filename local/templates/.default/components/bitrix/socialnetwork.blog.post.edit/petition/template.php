                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    ...
                                    echo "<div class='form-group'><label>Изображение</label>";
                                    ?>

                                    <input type="hidden" name="<?= $FIELD_NAME ?>_old_id"
                                           value="<?= $arPostField[VALUE] ?>"/>

                                        <?= CFile::InputFile($FIELD_NAME, 0, $arPostField[VALUE], false, 0, "", "class=\"form-control h-auto\"", 0, "", ' value="' . $arPostField[VALUE] . '"', true, true);
