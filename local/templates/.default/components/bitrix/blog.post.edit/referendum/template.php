                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-light">
                            <h2 class="card-title font-weight-semibold mb-0">Создание референдума</h2>

                        </div>
                        <div class="card-body flex-grow-1">

                            <label class="mb-3">Необходимо подготовить текст законопроекта, выносимого на референдум. Текст законопроекта должен быть разработан на основании текста исходной петиции и результатов обсуждений, приведенных ниже.</label>

                    <?if($arResult["POST_PROPERTIES"]["SHOW"] == "Y"):?>
                        <?foreach ($arResult["POST_PROPERTIES"]["DATA"] as $FIELD_NAME => $arPostField):
                            if($FIELD_NAME=="UF_BLOG_POST_DOC" || $FIELD_NAME=="UF_SECTION") continue;//pr($arPostField);
...
<?*/?>
            ...
            <div class="feed-buttons-block mb-3">
                <input type="hidden" name="save" value="Y">
                <input type="hidden" name="UF_STATUS" value="12">

                <input maxlength="255" size="70" tabindex="1" type="hidden" name="POST_TITLE" id="POST_TITLE" class="feed-add-post-inp feed-add-post-inp-active form-control" value="<?=$arResult["PostToShow"]["TITLE"]?>">

                <input tabindex="1" type="hidden" name="POST_MESSAGE" id="POST_MESSAGE" class="feed-add-post-inp feed-add-post-inp-active form-control" value="<?=$arResult['Post']["~DETAIL_TEXT"]?>">
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-header bg-light ">
                    ...
                    <h2 class="card-title font-weight-semibold mb-0"><?=$arResult["PostToShow"]["TITLE"]?></h2>
                ...
                <div class="card-body">
                    <div class="mb-0">
                        ...
                        $text = $p->convert($arResult["Post"]["DETAIL_TEXT"]);
                        ?>
                        <?= $text; ?>
                    </div>
                </div>
