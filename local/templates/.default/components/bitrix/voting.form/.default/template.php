            ...
            ?>">
                ...
                <div class="card-footer bg-white">
                    ...
                    <?if(true/*!empty($_REQUEST["post_id"])*/):?>
                        ...
                        <h5 class="text-danger">
                            Голосование <i class="icon-law  ml-2"></i>
                        </h5>
                        <div class="mb-3">
                        ...
                        ?>id="vote_radio_<?=$arAnswer["QUESTION_ID"]?>_<?=$arAnswer["ID"]?>" <?
							...
							<label for="vote_radio_<?=$arAnswer["QUESTION_ID"]?>_<?=$arAnswer["ID"]?>" class="text-danger font-weight-bold mb-1 font-size-lg text-uppercase"><?=$arAnswer["MESSAGE"]?></label>
						</span>
                                            <?
                                            break;
                                        case 1://checkbox?>
