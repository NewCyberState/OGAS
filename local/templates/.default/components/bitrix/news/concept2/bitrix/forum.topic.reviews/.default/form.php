...
<!--		<div class="reviews-reply-field reviews-reply-field-settings">-->
			<?
			/* SMILES */
			if (false/*$arResult["FORUM"]["ALLOW_SMILES"] == "Y"*/):
				?>
				<div class="reviews-reply-field-setting form-check">
                    <label for="REVIEW_USE_SMILES<?=$arParams["form_index"]?>" class="form-check-label">
					<input type="checkbox" class="form-check-input" name="REVIEW_USE_SMILES" id="REVIEW_USE_SMILES<?=$arParams["form_index"]?>" <?
					?>value="Y" <?=($arResult["REVIEW_USE_SMILES"]=="Y") ? "checked=\"checked\"" : "";?> <?
					?>tabindex="<?=$tabIndex++;?>" /><?
					?>&nbsp;<?=GetMessage("F_WANT_ALLOW_SMILES")?></label></div>
			<?
			endif;
			/* SUBSCRIBE */
			if (false/*$arResult["SHOW_SUBSCRIBE"] == "Y"*/):
				?>
...
<!--		</div>-->
		...
		<div class="reviews-reply-buttons">
			<input name="send_button" type="submit" class="btn btn-primary"     value="<?=GetMessage("OPINIONS_SEND")?>" tabindex="<?=$tabIndex++;?>" <?
			?>onclick="this.form.preview_comment.value = 'N';" />
			<input name="view_button" type="submit"  class="btn btn-primary" value="<?=GetMessage("OPINIONS_PREVIEW")?>" tabindex="<?=$tabIndex++;?>" <?
