            ...
            <div class="card mb-0">
                <div class="card-body">
                    <div class="text-center mb-3">
                        ...
                        <span class="d-block text-muted">Все поля обязательны</span>
                    </div>
                    ...
                    <input type="hidden" name="REGISTER[PERSONAL_CITY]" value="<?=$city?>">
                    <input type="hidden" name="REGISTER[PERSONAL_STATE]" value="<?=$country?>">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-feedback form-group-feedback-right">
                                <input size="30" class="form-control" placeholder="Имя" id="input_NAME" type="text"  name="REGISTER[NAME]" required value="<?=$arResult["VALUES"]["NAME"]?>" />
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-right">
                                ...
                                <input size="30" class="form-control" required placeholder="Фамилия" id="input_LAST_NAME" type="text"  name="REGISTER[LAST_NAME]" value="<?=$arResult["VALUES"]["LAST_NAME"]?>" />
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-feedback form-group-feedback-right">
                                <input size="30" class="form-control" required placeholder="E-mail" id="input_EMAIL" type="email"  name="REGISTER[EMAIL]" value="<?=$arResult["VALUES"]["EMAIL"]?>" />
                                <div class="form-control-feedback">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-feedback form-group-feedback-right">
                                ...
                                <input size="30" type="password" placeholder="Пароль" id="input_PASSWORD" name="REGISTER[PASSWORD]" required value="<?=$arResult["VALUES"]["PASSWORD"]?>" autocomplete="off" class="form-control password <?=(array_key_exists( "PASSWORD", $arResult["ERRORS"] ))? 'error': ''?>"  />
                                <div class="form-control-feedback">
                            ...
                            <div class="form-group form-group-feedback form-group-feedback-right">
                                ...
                                <input size="30" type="password" placeholder="Повтор пароля" id="input_CONFIRM_PASSWORD" name="REGISTER[CONFIRM_PASSWORD]" required value="<?=$arResult["VALUES"]["CONFIRM_PASSWORD"]?>" autocomplete="off" class="form-control confirm_password <?=(array_key_exists( "CONFIRM_PASSWORD", $arResult["ERRORS"] ))? 'error': ''?>" />
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <span class="d-block text-muted">Фотография профиля</span>

                            <div class="form-group form-group-feedback form-group-feedback-right">
                                <input size="30" type="file" required class="form-control h-auto" id="input_PERSONAL_PHOTO" name="REGISTER_FILES_PERSONAL_PHOTO" placeholder="Фотография профиля"/>
                                <div class="form-control-feedback">
                                    <i class="icon-file-upload text-muted"></i>
                                </div>
                    ...
                    <div class="text-center">
                        <a href="/auth/" name="Login" class="">Уже зарегистрирован</a>
                    </div>
