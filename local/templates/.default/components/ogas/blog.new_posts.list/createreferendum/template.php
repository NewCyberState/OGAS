        ...
        <div class="card">
            <div class="card-header header-elements-inline bg-white">
                ...
                <div class="header-elements">
                    <span><a href="<?=$url.$groupid?><?=$groupid?>"><?=$all?></a></span>
                </div>
            </div>
        </div>
    </div>
	...
	<?foreach($arResult["POSTS"] as $ind => $CurPost)
	{
        ...
        <div class="card">
            <div class="card-header bg-light d-flex header-elements-inline">
                <h6 class="font-weight-semibold mb-0 flex-grow-1 card-title">
                    <a href="<?=$CurPost["urlToPost"]?>" title="<?=$CurPost["TITLE"]?>"><?=$CurPost["TITLE"]?></a>
                </h6>
                <div class="header-elements">
                <span class="badge-light "><?=$arParams["STATUS_NAME"]?></span>
                </div>
            </div>
            <div class="card-header bg-white d-flex mb-0">
                <ul class="list-inline list-inline-dotted text-muted  mb-0">
                    ...
                    <li class="list-inline-item">
                        <span class="blog-post-day"><span class="blog-post-date-formated"><?=$CurPost["DATE_PUBLISH_FORMATED"]?></span>
                    </li>
                    <?/*foreach ($CurPost["CATEGORY"] as $cat):?>
                    <li class="list-inline-item">
                        <?//pr($cat)?>
                        <?="<a href='".$cat["urlToCategory"]."'>".$cat["NAME"]."</a>"?>
                    </li>
                    <?endforeach;*/?>
                </ul>
            ...
            <div class="card-body">
                  ...
                  <?//pr($CurPost);?>
                <div id="summary">
                    <div class="collapse" id="collapseSummary<?=$CurPost[ID]?>">
                        <?=$CurPost["TEXT_FORMATED"]?>
                    </div>
                    <?if(strlen($CurPost["TEXT_FORMATED"])>200):?>
                    <a class="collapsed" data-toggle="collapse" href="#collapseSummary<?=$CurPost[ID]?>" aria-expanded="false" aria-controls="collapseSummary"></a>
                    <?endif;?>
                </div>
            ...
            <div class="card-footer d-flex">
                ...
                <li class="list-inline-item"><a href="<?=$CurPost["urlToPost"]?>#comments"><?=GetMessage("BLOG_BLOG_BLOG_COMMENTS")?> <?=IntVal($CurPost["NUM_COMMENTS"]);?></a></li>
                </ul>
